...
. ▀   ▀█▄▀▪  ▀▀▀ .▀  ▀ ▀▀▀    ▀█▄▀▪▀▀ █▪    ▀▀▀ ▀▀▀ · ▀▀▀     ▀▀▀  ▀█▄▀▪.▀   
    ...
    Sms Atan Api Sayısı: {}                         
    Arama Yapan Api Sayısı: {}              {}by {}@VotreTeam\n  
    """.format(Fore.LIGHTCYAN_EX, len(servisler_sms), len(servisler_call), Style.RESET_ALL, Fore.LIGHTYELLOW_EX))
    try:
    ...
    if menu == 1:
        ...
        system("cls||clear")
        print(Fore.LIGHTWHITE_EX + "Votre")
        sleep(12)
    elif menu == 4:
        system("cls||clear")
